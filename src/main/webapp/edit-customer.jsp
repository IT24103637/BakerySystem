        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="mt-2">SweetDelight Bakery | Customer Edit</h1>
                </div>
            </div>
        </div>

        <div class="col-12 text-center">
            <img src="images/edit_customer.png" alt="Edit Logo" class="mt-3" style="width:25%"/>
        </div>
                ...
                <div class="col-sm-12 offset-lg-1 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            <button class="form-control btn btn-secondary" onclick="">Update</button>
                        </div>
                        <div class="col-6 mt-3">
