...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/images/pastry-icon.png" type="image/png">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/inventory.css">
</head>
<body>
<div class="inventory-container">
    <header class="inventory-header">
        <h1><img src="${pageContext.request.contextPath}/images/pastry-icon.png" alt="Pastry Icon" class="header-icon"> Sweet Bakery Inventory</h1>
        <a href="add-item" class="btn-add">Add New Item</a>
    </header>
    <!-- Rest of your inventory page -->
